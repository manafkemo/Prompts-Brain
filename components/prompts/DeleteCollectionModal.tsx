      ...
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-slate-950 border border-white/10 rounded-3xl p-8 shadow-2xl"
          >
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm mb-6 px-4">
                Are you sure you want to delete <span className="text-white font-bold">"{collectionName}"</span>? 
                This action is permanent and cannot be undone. 
                <br /><br />
                <span className="flex items-center justify-center gap-2 text-amber-400 font-medium">
                  <AlertCircle className="w-4 h-4" /> 
                  Prompts will remain in your library.
                </span>
              </p>
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 px-6 py-3 rounded-xl text-sm font-bold text-slate-400 hover:text-white hover:bg-slate-900 transition-all"
                >
                  Cancel
                </button>
                <button
